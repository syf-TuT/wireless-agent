...
def export_results_to_csv(results, slice_stats, intent_stats, file_path="fileName.csv"):
    ...
    try:
        ...
        headers = [
            ...
            "mMTC Total Rate Before (Mbps)", "mMTC Total Rate After (Mbps)",  # 添加mMTC列
...
1. eMBB (Enhanced Mobile Broadband) - Choose when the application primarily needs:
   ...
   - Example applications: video streaming, large file downloads/uploads, AR/VR, high-resolution video calls, messaging apps, web browsing
...
def main(num_users=4, export_file="fileName.csv"):
    ...
    ray_tracing_csv = r"C:\Users\86178\Desktop\WirelessAgent_R1\ray_tracing_results.csv"
