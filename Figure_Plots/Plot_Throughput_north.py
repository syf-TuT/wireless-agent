...
Y_rule_thro = [0,348.53, 476.78, 927.28, 1282.97, 1291.25, 1284.41]
Y_llm_thro =  [0, 225, 243.14, 352.26, 668.86, 788.86, 790.11]
Y_agent_thro = [0,268.93,385.21,835.74,1262.15,1259.58,1243.49]

# idle rate
Y_rule_idle = [100, 71.54, 59.23, 23.08, 0.0, 0.0, 0.0]
Y_llm_idle =   [100, 73.85, 66.15, 49.23, 23.08, 3.85, 3.46]
Y_agent_idle = [100, 78.54,67.23,31.54,0.77,0.0,0.0]
...
output_path = r'F:\code\wirelessagent\picture\Plot_Throughput_north.png'
