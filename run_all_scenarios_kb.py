#!/usr/bin/env python3
"""
Batch runner: execute all ray tracing scenarios for KB mode.
"""
...
def run_scenario(scenario_name: str, num_users: int = NUM_USERS) -> None:
    ...
    source_file = os.path.join(project_root, "with_knowledge_base", "WA_KB.py")
    ...
    try:
        import with_knowledge_base.WA_KB as wa_module
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run network slicing scenarios (KB)")
