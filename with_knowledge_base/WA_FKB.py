...
# Set up LLM - uses LLM_PROVIDER env var or default to deepseek
# Can also specify explicitly: get_llm("glm-4.7"), get_llm("glm-4.7"), etc.
llm = get_llm("glm-4.7")
...
def knowledge_base_query(query: str) -> str:
    ...
    if relevant_lines:
        ...
        result.append(
            "No information directly related to the query was found. Please refer to the complete knowledge base content.")
...
"""
    ...
    try:
        ...
        response = llm_with_token_tracking(llm, messages, "Beamforming_Bandwidth")
...
"""
    ...
    if slice_match:
        ...
        if llm_recommended_slice != kb_recommended_slice:
            ...
            print(
                f"LLM recommended {llm_recommended_slice} but knowledge base recommended {kb_recommended_slice}, using knowledge base recommendation")
...
"""
            ...
            response = llm_with_token_tracking(llm, messages, "Intent_Override")
...
if __name__ == "__main__":
    ...
    main(num_users=30,
         export_file=r"/run_results/batch_run/fkb/minimax-m2/network_slicing_results_TJU_east_minimax-M2.csv")  # The number of users can be adjusted as needed