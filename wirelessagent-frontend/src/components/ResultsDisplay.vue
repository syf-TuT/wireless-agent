      ...
      <el-tabs v-model="activeTab" class="results-tabs">
        ...
        <el-tab-pane name="statistics">
          ...
          <div class="statistics-content">
              ...
              <el-row :gutter="16">
                <el-col :xs="24" :sm="12" :md="8">
                  <div class="stat-card success-card">
                    ...
                    <div class="stat-content">
                      <div class="stat-value">{{ Math.round(displaySuccessCount) }}</div>
                ...
                <el-col :xs="24" :sm="12" :md="8">
                  <div class="stat-card danger-card">
                    ...
                    <div class="stat-content">
                      <div class="stat-value">{{ Math.round(displayFailedCount) }}</div>
                      <div class="stat-label">分配失败</div>
                    </div>
                    <div class="stat-progress">
                      <div class="progress-bar" :style="{ width: (100 - successRate) + '%' }"></div>
                    </div>
                  </div>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8">
                  <div class="stat-card primary-card">
                    ...
                    <div class="stat-content">
                      <div class="stat-value">{{ displaySuccessRate }}%</div>
              ...
              <el-row :gutter="16">
                <el-col :xs="24" :sm="12">
                  <div class="stat-card info-card">
                    ...
                    <div class="stat-content">
                      <div class="stat-value">{{ displayAvgRate }}</div>
            ...
            <!-- Charts Section -->
            <div class="stat-section charts-section">
...
const pieChartData = computed(() => [
  { name: 'eMBB', value: embbCount.value },
  { name: 'URLLC', value: urllcCount.value },
  { name: 'mMTC', value: mmtcCount.value }
])

const gaugeData = computed(() => {
  const totalBandwidth = 130 // 90 + 30 + 10 MHz
  const usedBandwidth = props.results
    .filter(r => r.bandwidth && !r.allocation_failed)
    .reduce((acc, r) => acc + r.bandwidth, 0)
  const utilization = Math.min(100, (usedBandwidth / totalBandwidth) * 100)
  return [{ name: '利用率', value: Math.round(utilization) }]
})

// Animated numbers
const displaySuccessCount = ref(0)
const displayFailedCount = ref(0)
const displaySuccessRate = ref(0)
const displayAvgRate = ref(0)

watch(() => props.results, () => {
  animateNumber(displaySuccessCount, successCount.value)
  animateNumber(displayFailedCount, failedCount.value)
  animateNumber(displaySuccessRate, successRate.value)
  animateNumber(displayAvgRate, avgRate.value)
}, { immediate: true })

function animateNumber(refValue: typeof displaySuccessCount, target: number) {
  const duration = 1500
  ...
  function update(currentTime: number) {
    ...
    refValue.value = Number((start + (target - start) * easeOut).toFixed(1))
...
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(1)) { animation-delay: 0.05s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(2)) { animation-delay: 0.1s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(3)) { animation-delay: 0.15s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(4)) { animation-delay: 0.2s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(5)) { animation-delay: 0.25s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(6)) { animation-delay: 0.3s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(7)) { animation-delay: 0.35s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(8)) { animation-delay: 0.4s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(9)) { animation-delay: 0.45s; }
:deep(.el-table .el-table__body-wrapper .el-table__body tr:nth-child(10)) { animation-delay: 0.5s; }
</style>
