...
def main():
    # File path
    file_path = "maps/TJU_south/TJU_south.osm"
    ...
    try:
        ...
        # Save results to CSV=============================================================================================================
        output_path = 'ray_tracing_results/ray_tracing_results_south.csv'  # Output file path modifed by Jingwen TONG
        ...
        plt.savefig('ray_tracing_map.png', dpi=300)
        plt.show()
